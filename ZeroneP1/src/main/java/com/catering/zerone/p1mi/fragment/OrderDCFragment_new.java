...
import com.catering.zerone.p1mi.adapter.branch.BigramHeaderAdapter;
import com.catering.zerone.p1mi.adapter.branch.PersonAdapter;
import com.catering.zerone.p1mi.adapter.branch.RecycleGoodsCategoryListAdapter;
import com.catering.zerone.p1mi.adapter.branch.options.ListViewOptionTitle;
...
import com.catering.zerone.p1mi.domain.options.OptionsBean;
import com.catering.zerone.p1mi.domain.options.OptionsBeanItem;
import com.catering.zerone.p1mi.event.AcceptMessage;
...
public class OrderDCFragment_new extends Fragment implements PersonAdapter.OnShopCartGoodsChangeListener, OnHeaderClickListener  {
    //商品类别列表
    //商品类别列表
